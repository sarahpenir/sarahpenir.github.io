...
I squealed internally as soon as he brought up <a href="http://calnewport.com/books/deep-work/">"deep work"</a>, which is pretty much my 2017 slogan, thanks to the urging of a friend to pick up Cal Newport's self-help book. It is never easy to focus on a single problem at a time, but it is somewhat inspiring to learn that Hadley Wickham also makes an active effort to exercise "deep work" on a daily basis in order to increase his productivity.
